...
export default function RDTeamsListPage() {
  ...
  // RD Registration IDs
  const RD_IDS = [
    "RD13", "RD20", "RD25", "RD29", "RD34", "RD36", "RD37", "RD42", "RD45", "RD46",
    "RD47", "RD52", "RD55", "RD60", "RD65", "RD69", "RD70", "RD78", "RD81", "RD192" , "RD80" , "RD268" , "RD117",
    "RD85", "RD91", "RD93", "RD96", "RD99", "RD128", "RD131", "RD135", "RD136", "RD138","RD325", "RD218" , "RD11" , "RD22",
    "RD141", "RD154", "RD159", "RD163", "RD168", "RD178", "RD179", "RD183", "RD191", "RD194","RD134" , "RD132" , "RD147",
    "RD195", "RD197", "RD203", "RD205", "RD206", "RD208", "RD209", "RD211", "RD212", "RD213","RD290",
    "RD166","RD97","RD224",
    "RD215", "RD217", "RD223", "RD225", "RD239", "RD245", "RD250", "RD252", "RD275", "RD276","RD31",
    "RD281", "RD283", "RD293", "RD294", "RD296", "RD18", "RD272", "RD301", "RD306", "RD307","RD192",
    "RD308", "RD309", "RD310", "RD312", "RD313", "RD319", "RD320", "RD324", "RD279", "RD288","RD268"
  ];
  ...
  const fetchTeams = async () => {
    ...
    try {
      ...
      if (data.success) {
        const allTeamsData = data.teams || [];
        
        // Filter only RD teams
        const rdTeamsData = allTeamsData.filter(team => 
          RD_IDS.includes(team.registrationId)
        );
        
        setTeams(rdTeamsData);
        setTotalCount(rdTeamsData.length);
        
        const collegeMap = new Map();
        rdTeamsData.forEach(team => {
        ...
        calculateStats(rdTeamsData);
        
        console.log("Fetched RD teams:", rdTeamsData);
      } else {
  ...
  const downloadStatisticsAsPDF = () => {
    let htmlContent = `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>CodeFusion 2026 - RD Teams Report</h1>
          ...
          <div class="stats-grid">
            <div class="stat-card">
              <div class="stat-label">Total RD Teams</div>
    ...
    link.setAttribute("download", `CodeFusion_RD_Statistics_${new Date().toISOString().split('T')[0]}.pdf`);
  ...
  const downloadTeamsAsExcel = () => {
    let csvContent = "CODEFUSION RD TEAMS DETAILS\n";
    ...
    link.setAttribute("href", url);
    link.setAttribute("download", `CodeFusion_RD_Teams_${new Date().toISOString().split('T')[0]}.csv`);
    link.style.visibility = "hidden";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-white rounded-lg border-2 border-[#002147] p-6 hover:shadow-lg transition">
              <p className="text-xs uppercase tracking-wider text-gray-600 font-semibold">Total RD Teams</p>
        ...
        {isLoading && (
          <div className="text-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#002147] mx-auto mb-4"></div>
            <p className="text-gray-600">Loading RD teams data...</p>
          </div>
        )}
        ...
        {!isLoading && !error && teams.length === 0 && (
          <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
            <p className="text-gray-600 text-lg font-semibold">No RD teams have registered yet</p>
          </div>
        )}
        ...
        {!isLoading && !error && sortedTeams.length > 0 && (
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-bold text-[#002147]">RD Teams Details</h2>
              <button
        ...
        {!isLoading && !error && sortedTeams.length > 0 && (
          <div className="mt-6 text-sm text-gray-600 text-center">
            Showing {sortedTeams.length} of {teams.length} RD teams
          </div>
        )}
      </main>
    </div>

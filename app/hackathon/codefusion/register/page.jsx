...
const RegistrationForm = () => {
  ...
  return (
    <div className="min-h-screen bg-white px-4 pt-40 md:pt-56 pb-12 font-[SUSE,sans-serif]">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white border-2 border-[#002147]/10 rounded-2xl shadow-lg p-8 md:p-12 text-center">
          <h2 className="text-3xl font-bold text-[#002147] mb-4">
            Registrations Closed
          </h2>
          <p className="text-lg text-gray-600">
            Registration for CodeFusion 2025 has ended. Thank you for your interest!
          </p>
        </div>
      </div>
    </div>

...
const TimelineData = [
  ...
  { date: "JAN 09 ", title: "Registration Closes", icon: CalendarX, desc: "Final deadline; no late entries allowed." },
  { date: "JAN 09 ", title: "Shortlisting Round", icon: Filter, desc: "Technical evaluation by expert panels." },
  { date: "JAN 09 ", title: "Results Announcement", icon: Megaphone, desc: "Teams cleared for participation announced." },
  { date: "JAN 09 ", title: "Payment Window", icon: CreditCard, desc: "Fee submission enabled for shortlisted candidates." },
